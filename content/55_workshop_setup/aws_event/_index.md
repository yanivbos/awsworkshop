...
Once you have completed the step above, you can leave the AWS console open. You can now move to the [**Create a workspace**](/55_workshop_setup/10_cloud9.html) section.
